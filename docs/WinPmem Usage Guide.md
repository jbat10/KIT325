...
winpmem.exe ../output/WinPmem/physmem.raw

![WinPmem command normal](./Images/winpmemnorm.PNG)
...
![WinPmem ouput](./Images/winpmemoutput.PNG)

If these steps are completed, a physical memory dump has been acquired for further investigation.
